...
public class Client extends JFrame{
	...
	//this method sends a message to connected clients
		...
		try
		{
			byte [] dataToSend = encryption(message).getBytes();
   ...
   // Converts the message into ascii chars, then encrypts the message according to the length of the message.
   ...
   //String name = "Hello world";
      ...
      for (int i = 0 ;i < len; i++){
         char character = mes.charAt(i); 
         int ascii = (int) character+len;
